...
function decryptor_reaction(key_or_keys, password_input, decrypted_content, fallback_used=false) {
    if (key_or_keys) {
        ...
        let encrypted_something = {'mkdocs-encrypted-toc': ['nav', 'class'], 'mkdocs-encrypted-footer': ['div', 'id'], 'mkdocs-encrypted-footer-meta': ['div', 'id'], 'md-footer__inner': ['nav', 'class'], 'md-nav': ['nav', 'class']};
